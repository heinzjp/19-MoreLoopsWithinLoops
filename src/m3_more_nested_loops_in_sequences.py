...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 99
    answer = largest_number(([1, 99, 3], [], [-57, 72]))
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    for i in range(len(seq_seq)):
        for u in range(len(seq_seq[i])):
            if seq_seq[i][u] > max_num:
                max_num = seq_seq[i][u]
    return max_num
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -57
    answer = largest_negative_number(([-1, 99, 3], [-57, 72]))
    print('Expected and actual are:', expected, answer)

    # Test 2:
    expected = None
    answer = largest_negative_number(([77, 234, 5664], [1, 67, 0], [57, 72]))
    print('Expected and actual are:', expected, answer)

    # Test 3:
    expected = -100000
    answer = largest_negative_number(([45, -1, 55], [-57, -100000]))
    print('Expected and actual are:', expected, answer)

    # Test 4:
    expected = None
    answer = largest_negative_number(([2345, 866, 4], [65, 35, 6]))
    print('Expected and actual are:', expected, answer)
